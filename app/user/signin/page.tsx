...
export default function LoginPage() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0B0D0F] px-6">
      {/* faint grid texture */}
      <div
      ...
      {/* ambient glow */}
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[480px] w-[480px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#6E56CF] opacity-[0.10] blur-[120px]" />
        ...
        <div className="overflow-hidden rounded-xl border border-[#23272E] bg-[#111418] shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_24px_48px_-12px_rgba(0,0,0,0.6)]">
          ...
          <div className="px-8 py-10">
            ...
            >
              <button
                type="submit"
                className="group flex w-full items-center justify-center gap-2.5 rounded-lg border border-[#2A2F36] bg-[#1A1D21] px-4 py-3 text-[14px] font-medium text-[#E6E8EB] transition-colors duration-150 hover:bg-[#21252A] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6E56CF]"
              >
